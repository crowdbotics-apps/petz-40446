"""
Django settings for petz_40446 project.
...
WSGI_APPLICATION = 'petz_40446.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "petz_40446 API",
    "DESCRIPTION": "API documentation for petz_40446 App",
    "VERSION": "v1",
}
